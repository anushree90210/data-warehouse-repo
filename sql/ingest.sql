...
create table fhv_bases as select * from read_csv_auto('./data/data/fhv_bases.csv', union_by_name=True, 
filename=True, all_varchar=1);
create table daily_citi_bike_trip_counts_and_weather as select * from 
read_csv_auto('./data/data/daily_citi_bike_trip_counts_and_weather.csv', union_by_name=True, filename=True, 
all_varchar=1);
...
create table bike_data as select * from read_csv_auto('./data/data/bike/*-citibike-tripdata.csv.gz', 
union_by_name=True, filename=True, all_varchar=1);
